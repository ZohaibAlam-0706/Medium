...
export const TopBar = ({authorName, post} : author) => {
    ...
    return <div>
        <div className="h-12 flex justify-between border-b-2">
            ...
            <div className="flex">
                {post ? <div>
                    <button className="mr-10 mt-2 w-24 h-8 text-lg rounded-full bg-green-500 text-white">Publish</button>    
                </div> :
                <div onClick={goToPublish} className="cursor-pointer mr-10">
